...
if(isset($_POST['regUname'])){
	$uname=mysqli_real_escape_string($con,$_POST["regUname"]); }

if(isset($_POST['regUemail'])){
	$email = mysqli_real_escape_string($con,$_POST["regUemail"]); }

if(isset($_POST['regUpassword'])){
	$pword =mysqli_real_escape_string($con,$_POST["regUpassword"].$randomSalt);
	$SHpword=sha1($pword);
	}
